...
const Comment = () => {
    ...
    return (
        <div className=' font-poppins'>
            <h1 className=' text-center text-2xl text-gray-400 font-semibold`'>Server Comment</h1>
            ...
            <div className='bg-base-300  py-3'>
                ...
                <div className=' space-y-3 md:w-[400px] rounded-md mx-auto  text-center bg-white p-10 my-10'>
                      ...
                      <input type="text" placeholder="Minecraft Name" className="input input-bordered w-full max-w-xs" />
